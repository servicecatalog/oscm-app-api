...
public class ApiParamValue {
    ...
    public static final String ORGANIZATION_ID = "Id of organization";

    public static final String SETTING_ID = "Id of configuration setting";
    public static final String SETTING = "Setting object";
}
